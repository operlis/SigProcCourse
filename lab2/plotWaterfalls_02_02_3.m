...
% ylim [0-3000 Hz] covers all Bessel sidebands visible for beta up to 5,
% with extra margin to show the full sideband spread at beta=5.
...
% ylim [0-3000 Hz] covers all 8 standard DTMF frequencies (697-1633 Hz)
% with margin. View angle [-45 60]: reversed azimuth places the digit
% sequence left-to-right; elevation=60 gives a clear top-down perspective
% on the two simultaneous frequency peaks per digit.
% zlim [-40 20 dB]: limits the dynamic range to 60 dB so the DTMF peaks
% stand out clearly above the noise floor.
% =========================================================================
